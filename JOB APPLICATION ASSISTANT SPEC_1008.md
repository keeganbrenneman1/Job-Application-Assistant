...
## v1 / v2 / v3 / v4 / v-next
> Numbering below is superseded — v3 and v4 as actually built don't match this list
> (the "freeform manual context" feature described as v4 here shipped as v3; cap
> removal described as v3 here is v5 in the current roadmap). This section is kept
> for history; `README.md`'s "What's not built yet" is the current source of truth
> for what's next.
